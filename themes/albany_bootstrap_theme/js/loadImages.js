document.addEventListener("DOMContentLoaded",function(){
    ...
    for(let speakerCount = 0; speakerCount < speakerImages.length; speakerCount++)
    {
        ...
        let imageURL = 'https://raw.githubusercontent.com/UjashM/RISE2019/dev/img/Speakers/' + speakerLink +'.png';
